...
class RSAFileProcessor:
    ...
    def generate_keys(self, save_to_file=True):
    ...
    def encrypt_file(self, input_path, output_path='encrypted.txt'):
    ...
    def decrypt_file(self, input_path, output_path='decrypted.txt'):
    ...
    def process_directory(self, directory, operation='encrypt', output_dir='processed'):
...
def main():
    ...
    parser = argparse.ArgumentParser(description="RSA-OAEP File Encryption/Decryption Tool")
    ...
    enc_parser.add_argument('--output', default='encrypted.txt', help='Output file path')

    # Decryption command
    dec_parser = subparsers.add_parser('decrypt', help='Decrypt a file')
    dec_parser.add_argument('input', help='Input file path')
    dec_parser.add_argument('--output', default='decrypted.txt', help='Output file path')
